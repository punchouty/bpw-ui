(function () {
  ...
  angular
    .module('app')
    .controller('resellersListCtrl', resellersListCtrl);

  resellersListCtrl.$inject = ['$state', '$stateParams', '$scope', '$http', 'logger', 'NgTableParams', '$filter' , 'resellerFactory' , '$rootScope' ];
  /* @ngInject */
  function resellersListCtrl($state, $stateParams, $scope, $http, logger, NgTableParams, $filter , resellerFactory , $rootScope ) {
