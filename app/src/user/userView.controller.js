(function () {
  ...
  userViewCtrl.$inject = ['$state', '$filter', '$scope', 'logger', 'userFactory' , '$rootScope', '$window' ];
  /* @ngInject */
  function userViewCtrl($state, $filter, $scope, logger, userFactory , $rootScope, $window ) {
