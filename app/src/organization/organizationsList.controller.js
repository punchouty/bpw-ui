(function () {
  ...
  angular
    .module('app')
    .controller('organizationsListCtrl', organizationsListCtrl);

  organizationsListCtrl.$inject = ['$state', '$stateParams', '$scope', '$http', 'logger', 'NgTableParams', '$filter' , 'organizationFactory' , '$rootScope' ];
  /* @ngInject */
  function organizationsListCtrl($state, $stateParams, $scope, $http, logger, NgTableParams, $filter , organizationFactory , $rootScope ) {
