(function () {
  ...
  angular
    .module('app')
    .controller('quickNewProjectCtrl', quickNewProjectCtrl);

  quickNewProjectCtrl.$inject = ['$state', '$stateParams', '$scope', '$http', 'logger', 'NgTableParams', '$filter', '$uibModal' , 'projectFactory' , '$rootScope', 'Upload', '$window' ];
  /* @ngInject */
  function quickNewProjectCtrl($state, $stateParams, $scope, $http, logger, NgTableParams, $filter , $uibModal, projectFactory , $rootScope, Upload, $window) {
